...
* **Colorizr**: Once the tests pass and the simulation is accurate then use your Colorizr gem to add color to the text output to the terminal. You may want to color the tribe names, the contestant names, the winners or anything else. Get creative with your colorizing, it will surely help visibility.
* **Tips**:
